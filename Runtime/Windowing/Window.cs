    ...
    public sealed class Window : IDisposable
    {
        public Window(in WindowDesc desc)
        {
            ...
            WindowCreateInfo info = new WindowCreateInfo()
            {
                ...
                X = (int)desc.Offset.X,
                Y = (int)desc.Offset.Y,
                WindowInitialState = (Veldrid.WindowState)desc.InitialState
            };
        ...
        public WindowState State
        {
            get
            {
                return (WindowState)UnderlyingWindow.WindowState;
            }
            set
            {
                UnderlyingWindow.WindowState = (Veldrid.WindowState)value;
            }
        }
